# xy-from-visit
Code to go from master catalog RA, Dec to catalog with  X/Y on a particular mosaic. Makes use of convex hull dcode kindly provided by Max Franco and WCS -> xy code provided by [@antonkoekemoer](https://github.com/antonkoekemoer)
